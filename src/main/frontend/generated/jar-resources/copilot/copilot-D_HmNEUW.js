...
const mn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), Ve = "copilot-", sl = "24.9.11", ll = "undefined", $u = "attention-required", Du = "https://plugins.jetbrains.com/plugin/23758-vaadin", ku = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Tu = "https://marketplace.eclipse.org/content/vaadin-tools";
function Iu(e) {
...
function cc() {
  Ae.push(import("./copilot-log-plugin--q3jI3DE.js")), Ae.push(import("./copilot-info-plugin-CDFYhJUi.js")), Ae.push(import("./copilot-features-plugin-BWK0b65m.js")), Ae.push(import("./copilot-feedback-plugin-BADJyP6F.js")), Ae.push(import("./copilot-shortcuts-plugin-C9hqxmmU.js"));
}
function uc() {
  {
...
let vi = class extends lc {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-MdYiIpmm.js"), await import("./copilot-init-step2-BKxU4bo3.js"), ml(), cc(), this.tabIndex = 0, Vt.hostConnectedCallback(), window.addEventListener("keydown", Kn), this.addEventListener("keydown", pi), y.onSend(this.handleSendEvent), this.removers.push(y.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
